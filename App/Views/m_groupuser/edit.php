          ...
          <div class="card-header">
            <div class = "row">
              ...
              <div class="col-6 text-right">
                <a href="<?= base_url('m_groupuser')?>"><i class = "fa fa-table"></i> Data</a>
              </div>
            </div>
          </div>
          <div class="card-body">                
            <form method = "post" action = "<?= base_url('m_groupuser/editsave');?>">
              ...
              <div class="form-group">       
                ...
                <a href="<?= base_url('m_groupuser')?>" value="<?= lang('Form.cancel')?>" class="btn btn-primary"><?= lang('Form.cancel')?></a>
              </div>
            </form>
          </div>
        </div>
